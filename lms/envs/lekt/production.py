...
# CMS authentication
IDA_LOGOUT_URI_LIST.append("http://studio.local.lektorium.tv/logout/")

# Required to display all courses on start page
SEARCH_SKIP_ENROLLMENT_START_DATE_FILTERING = True


ACCOUNT_MICROFRONTEND_URL = "http://apps.local.lektorium.tv/account"


WRITABLE_GRADEBOOK_URL = "http://apps.local.lektorium.tv/gradebook"


LEARNING_MICROFRONTEND_URL = "http://apps.local.lektorium.tv/learning"


PROFILE_MICROFRONTEND_URL = "http://apps.local.lektorium.tv/profile/u/"


LOGIN_REDIRECT_WHITELIST.append("apps.local.lektorium.tv")
CORS_ORIGIN_WHITELIST.append("http://apps.local.lektorium.tv")
CSRF_TRUSTED_ORIGINS.append("apps.local.lektorium.tv")